...
- **AWS Local Zones:** An extension of an AWS Region that places AWS compute, storage, database, and other select services closer to large population, industry, and IT centers.
    ...
    - **Supported Services:** Includes Amazon EC2, Amazon EBS, Amazon VPC, Amazon ECS, Amazon EKS, and Application Load Balancer. It also supports orchestration/management services such as:
        - **Amazon EC2 Auto Scaling**
        - **Amazon EKS / ECS clusters**
